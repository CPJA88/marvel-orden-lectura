...
console.log(`PWA Marvel construida con ${uiVersion}: portadas por ID GCD y resolución Unlimited por navegación incremental entre números vecinos; sin Google/Bing/Search/Load More para metadata.`);
