...
const uiVersion='v1.2.11-catalog-resolver';
...
sw=sw.replace("'styles.css','app.js'","'styles.css','enhancements.css','diagnostics.css','app.js','diagnostics.js','resolver-ui.js','cache-ui.js','diagnostic-trace.js','diagnostic-catalog.js'");
...
console.log(`PWA Marvel construida con ${uiVersion}: resolución principal mediante catálogo oficial de series de Marvel; buscadores solo como fallback; diagnóstico incluye serie/catálogo.`);
