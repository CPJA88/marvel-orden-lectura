...
const uiBaseVersion='v1.2.34-official-coverage';
...
const scripts=['resolver-ui.js','cache-ui.js','cache-authority-v129.js','marmota-ui.js','stability-v22.js','diagnostic-v22.js','search-filter-fix-v132.js'];
...
sw=sw.replace("'styles.css','app.js'","'styles.css','enhancements.css','diagnostics.css','app.js','diagnostics.js','resolver-ui.js','cache-ui.js','cache-authority-v129.js','marmota-ui.js','stability-v22.js','diagnostic-v22.js','search-filter-fix-v132.js','data/marvel-cache/index.json'");
...
console.log(`PWA Marvel construida con ${uiVersion}: índice preinstalado=${baked.localCount}; formato=${baked.version||1}; verificación oficial=${Boolean(baked.officiallyVerified)}; cobertura oficial completa=${Boolean(baked.officialCoverageAudit?.completed)}; MU=${baked.matched}; deeplinks preconstruidos=${baked.linkReady||0}; deeplinks pendientes=${baked.linkMissing||0}. NOT_LISTED ya no se presenta como ausencia de Unlimited. Pantalla inicial con progreso real de carga; filtros globales en memoria. Marmota integrado por colección.`);