...
const uiVersion='v1.2.17-marvel-loadmore';
...
console.log(`PWA Marvel construida con ${uiVersion}: prueba controlada del Load More histórico real de Marvel con count=20, limit=18 y totalcount; sin walkers masivos.`);
