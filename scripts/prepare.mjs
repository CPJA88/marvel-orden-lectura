...
const uiVersion='v1.2.14-marvel-search';
...
console.log(`PWA Marvel construida con ${uiVersion}: catálogo de serie + búsqueda exacta oficial Marvel con offset=0; sin walkers masivos ni búsquedas Google desde el Worker.`);
