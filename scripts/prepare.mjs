...
const uiVersion='v1.2.7-meta-cache-fix';
...
console.log(`PWA Marvel construida con ${uiVersion}: resultados Marvel positivos y portadas no se degradan; falsos no-identificados se reintentan; apertura Smart Link estable sin cambios.`);
