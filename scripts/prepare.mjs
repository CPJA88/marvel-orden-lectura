...
const uiBaseVersion='v1.2.40-reader-fallback';
const sourceFiles=['index.html','styles.css','enhancements.css','diagnostics.css','app.js','diagnostics.js','resolver-ui.js','cache-ui.js','cache-authority-v129.js','marvel-reader-fallback-v1240.js','coverage-truth-v135.js','marmota-ui.js','stability-v22.js','diagnostic-v22.js','search-filter-fix-v132.js'];
...
const scripts=['resolver-ui.js','cache-ui.js','cache-authority-v129.js','marvel-reader-fallback-v1240.js','coverage-truth-v135.js','marmota-ui.js','stability-v22.js','diagnostic-v22.js','search-filter-fix-v132.js'];
...
sw=sw.replace("'styles.css','app.js'","'styles.css','enhancements.css','diagnostics.css','app.js','diagnostics.js','resolver-ui.js','cache-ui.js','cache-authority-v129.js','marvel-reader-fallback-v1240.js','coverage-truth-v135.js','marmota-ui.js','stability-v22.js','diagnostic-v22.js','search-filter-fix-v132.js','data/marvel-cache/index.json'");
...
console.log(`PWA Marvel construida con ${uiVersion}: índice preinstalado=${baked.localCount}; formato=${baked.version||1}; verificación oficial=${Boolean(baked.officiallyVerified)}; cobertura oficial v2 completa=${Boolean(baked.officialCoverageAudit?.completed&&Number(baked.officialCoverageAudit?.version)>=2)}; MU=${baked.matched}; deeplinks UUID preconstruidos=${baked.linkReady||0}; UUID pendientes=${baked.linkMissing||0}. Los 7 UUID pendientes usan únicamente el fallback reader oficial verificado por allowlist. Los NO_DIGITAL antiguos se revalidan antes de mostrarse como ausencia definitiva. NOT_LISTED no equivale a ausencia de Unlimited. Pantalla inicial con progreso real de carga; filtros globales en memoria. Marmota integrado por colección.`);
