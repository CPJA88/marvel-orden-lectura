...
const uiVersion='v1.2.0-reading';

for(const file of [archive,path.join(source,'index.html'),path.join(source,'styles.css'),path.join(source,'enhancements.css'),path.join(source,'app.js')]){
...
if(!sw.includes("'enhancements.css'"))sw=sw.replace("'styles.css','app.js'","'styles.css','enhancements.css','app.js'");
...
for(const required of ['index.html','app.js','styles.css','enhancements.css','manifest.webmanifest','sw.js','data/meta.json','data/search.json','data/series.json'])await fs.access(path.join(output,required));
console.log(`PWA Marvel construida con ${uiVersion}: modo lectura, caché Marvel, reimpresiones, fichas de serie y portadas lazy.`);
